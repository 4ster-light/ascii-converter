...
export const Layout: React.FC<{ children: React.ReactNode }> = ({
	...
	return (
		<div className="min-h-screen p-8 bg-base-200 transition-colors duration-800">
					...
					<div>
						...
						<div className="flex gap-4">
							<a
								...
								className="link link-primary hover:text-secondary transition-colors"
							>
								Twitter
							</a>
							<a
								href="https://github.com/4ster-light"
								className="link link-primary hover:text-secondary transition-colors"
							>
								GitHub
							</a>
